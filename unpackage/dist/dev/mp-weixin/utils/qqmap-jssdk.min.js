...
var EARTH_RADIUS = 637813649e-2;
var Utils = { safeAdd(x, y) {
  ...
  common_vendor.wx$1.getLocation({ type: "gcj02", success, fail, complete });
  ...
  if (feature == "search") {
    ...
    param.success(data, { searchResult, searchSimplify });
    ...
    if (reverseGeocoderResult.pois) {
      ...
      param.success(data, { reverseGeocoderResult, reverseGeocoderSimplify, pois, poisSimplify });
    } else {
      param.success(data, { reverseGeocoderResult, reverseGeocoderSimplify });
    }
  } else if (feature == "geocoder") {
    var geocoderResult = data.result;
    var geocoderSimplify = { title: geocoderResult.title || null, latitude: geocoderResult.location && geocoderResult.location.lat || null, longitude: geocoderResult.location && geocoderResult.location.lng || null, adcode: geocoderResult.ad_info && geocoderResult.ad_info.adcode || null, province: geocoderResult.address_components && geocoderResult.address_components.province || null, city: geocoderResult.address_components && geocoderResult.address_components.city || null, district: geocoderResult.address_components && geocoderResult.address_components.district || null, street: geocoderResult.address_components && geocoderResult.address_components.street || null, street_number: geocoderResult.address_components && geocoderResult.address_components.street_number || null, level: geocoderResult.level || null };
    param.success(data, { geocoderResult, geocoderSimplify });
  } else if (feature == "getCityList") {
    var provinceResult = data.result[0];
    var cityResult = data.result[1];
    var districtResult = data.result[2];
    param.success(data, { provinceResult, cityResult, districtResult });
    ...
    param.success(data, { calculateDistanceResult, distance });
...
class QQMapWX {
  ...
  search(options) {
    ...
    var locationsuccess = function(result) {
      ...
      common_vendor.wx$1.request(Utils.buildWxRequestConfig(options, { url: URL_SEARCH, data: requestParam }, "search"));
    };
  ...
  getSuggestion(options) {
    ...
    var requestParam = { keyword: options.keyword, region: options.region || "全国", region_fix: options.region_fix || 0, policy: options.policy || 0, page_size: options.page_size || 10, page_index: options.page_index || 1, get_subpois: options.get_subpois || 0, output: "json", key: that.key };
    if (options.address_format) {
      requestParam.address_format = options.address_format;
    }
    if (options.filter) {
    ...
    if (options.location) {
      var locationsuccess = function(result) {
        ...
        common_vendor.wx$1.request(Utils.buildWxRequestConfig(options, { url: URL_SUGGESTION, data: requestParam }, "suggest"));
      };
      Utils.locationProcess(options, locationsuccess);
    } else {
      if (options.sig) {
  ...
  reverseGeocoder(options) {
    ...
    var locationsuccess = function(result) {
      ...
      common_vendor.wx$1.request(Utils.buildWxRequestConfig(options, { url: URL_GET_GEOCODER, data: requestParam }, "reverseGeocoder"));
    };
    Utils.locationProcess(options, locationsuccess);
  }
  geocoder(options) {
    ...
    common_vendor.wx$1.request(Utils.buildWxRequestConfig(options, { url: URL_GET_GEOCODER, data: requestParam }, "geocoder"));
  }
  getCityList(options) {
    var that = this;
    options = options || {};
    ...
    common_vendor.wx$1.request(Utils.buildWxRequestConfig(options, { url: URL_CITY_LIST, data: requestParam }, "getCityList"));
  }
  getDistrictByCityId(options) {
    ...
    common_vendor.wx$1.request(Utils.buildWxRequestConfig(options, { url: URL_AREA_LIST, data: requestParam }, "getDistrictByCityId"));
  }
  calculateDistance(options) {
    ...
    if (requestParam.mode == "straight") {
      var locationsuccess = function(result) {
        ...
        return options.success(data, { calculateResult, distanceResult });
      };
      Utils.locationProcess(options, locationsuccess);
    } else {
      var locationsuccess = function(result) {
        ...
        common_vendor.wx$1.request(Utils.buildWxRequestConfig(options, { url: URL_DISTANCE, data: requestParam }, "calculateDistance"));
      };
      Utils.locationProcess(options, locationsuccess);
    }
  }
  direction(options) {
    ...
    var locationsuccess = function(result) {
      ...
      common_vendor.wx$1.request(Utils.buildWxRequestConfig(options, { url: SET_URL_DIRECTION, data: requestParam }, "direction"));
    };
    Utils.locationProcess(options, locationsuccess);
  }
}
