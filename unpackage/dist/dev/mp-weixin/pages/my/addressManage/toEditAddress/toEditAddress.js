...
const _sfc_main = {
  __name: "toEditAddress",
  setup(__props) {
    let curAddressId = common_vendor.ref(0);
    ...
    common_vendor.onMounted(() => {
      let curAddressInfo = common_vendor.index.getStorageSync("curAddressInfo");
      curAddressId.value = curAddressInfo.id;
      userName.value = curAddressInfo.linkMan;
      phoneNumber.value = curAddressInfo.mobile;
      detailAddress.value = curAddressInfo.address;
      isDefaultAddress.value = curAddressInfo.defaultFlag === 0 ? false : true;
      community.value = curAddressInfo.communityName;
      getCommunities();
    });
    return (_ctx, _cache) => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-39637b18"], ["__file", "D:/Lydia/NOTE/lydia_note3/zhailijia-uni/pages/my/addressManage/toEditAddress/toEditAddress.vue"]]);
